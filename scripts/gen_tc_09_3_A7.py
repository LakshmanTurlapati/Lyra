...
"""gen_tc_09_3_A7.py -- Generate 500 ShareGPT tool-calling samples (TC-A).

Domain: weather, geolocation, maps, calendar, scheduling.

Seed: 1009313A.

Output: datasets/tool-calling/raw-09.3/batch-13-A.jsonl  (exactly 500 lines)
"""
import hashlib
import json
import random
...
OUT_PATH = ROOT / "datasets" / "tool-calling" / "raw-09.3" / "batch-13-A.jsonl"
...
def main():
    seed_int = int(hashlib.md5(b"1009313A").hexdigest(), 16) % (2**32)
