...
"""gen_knowledge_09_3_F.py -- Generate 500 ShareGPT knowledge samples (mixed).

Subagent F (KNOW-C) of phase 09.3-01 wave 3. Sibling generators A/B/C/D/E
already produced ~2500 samples. This batch covers a fresh slice of topics
across 7 categories (science, math, technology, history, arts_and_humanities,
everyday_life, current_events) and all 6 sub-angles, with no topic overlap
versus prior batches.

Seed: 1009311F (deterministic shuffle of (cat, topic, sub_angle) seeds
from the local kernel bank).

Output: datasets/knowledge/raw-09.3/batch-11-A-knowledge.jsonl
"""
import hashlib
import json
import random
...
OUT_PATH = ROOT / "datasets" / "knowledge" / "raw-09.3" / "batch-11-A-knowledge.jsonl"
SEED_STR = "1009311F"
...
from gen_knowledge_09_3_F_data import T  # noqa: E402
