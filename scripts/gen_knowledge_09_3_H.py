...
"""gen_knowledge_09_3_H.py -- Generate 500 ShareGPT knowledge samples (mixed).

Subagent H (KNOW-E) of phase 09.3-01 wave 5. Sibling generators A/B/C/D/E/F/G
already produced ~3500 samples. This batch covers a fresh slice of topics
across multiple categories and all 6 sub-angles.

Seed: 1009313H

Output: datasets/knowledge/raw-09.3/batch-13-A-knowledge.jsonl
"""
import hashlib
import json
import random
...
OUT_PATH = ROOT / "datasets" / "knowledge" / "raw-09.3" / "batch-13-A-knowledge.jsonl"
SEED_STR = "1009313H"
...
from gen_knowledge_09_3_H_data import T  # noqa: E402
