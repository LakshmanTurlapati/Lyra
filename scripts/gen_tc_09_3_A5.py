...
Output: datasets/tool-calling/raw-09.3/batch-11-A.jsonl  (exactly 500 lines)
"""
import hashlib
import json
import random
...
OUT_PATH = ROOT / "datasets" / "tool-calling" / "raw-09.3" / "batch-11-A.jsonl"
...
def main():
    seed_int = int(hashlib.md5(b"1009311A").hexdigest(), 16) % (2**32)
