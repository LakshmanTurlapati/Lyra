...
"""gen_knowledge_09_3_I.py -- Generate 500 ShareGPT knowledge samples (mixed).

Subagent I (KNOW-F) of phase 09.3 wave 6. Sibling generators A/B/C/D/E/F/G/H
already produced ~4000 samples. This batch covers a fresh slice of topics
across multiple categories and all 6 sub-angles.

Seed: 1009314I

Output: datasets/knowledge/raw-09.3/batch-14-A-knowledge.jsonl
"""
import hashlib
import json
import random
...
OUT_PATH = ROOT / "datasets" / "knowledge" / "raw-09.3" / "batch-14-A-knowledge.jsonl"
SEED_STR = "1009314I"
...
from gen_knowledge_09_3_I_data import T  # noqa: E402
